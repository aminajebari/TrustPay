                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4 custom-scrollbar">
                    {organizations.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-center p-8">
                            <div className="w-20 h-20 bg-linear-to-br from-[#1A56DB]/20 to-[#3B82F6]/20 rounded-full flex items-center justify-center mb-4">
                        ...
                        organizations.map((org, index) => (
                            <div
                                ...
                                className={`relative p-4 sm:p-5 bg-linear-to-br from-slate-800/50 to-slate-700/30 border ${selectedOrg === org.id
                                    ...
                                    : 'border-slate-700/50'
                                    } rounded-xl cursor-pointer hover:border-[#3B82F6]/50 transition-all duration-300 backdrop-blur-sm group/card animate-slide-in overflow-hidden`}
                                style={{ animationDelay: `${index * 0.1}s` }}
                            >
                                {/* Hover effect gradient */}
                                <div className="absolute inset-0 bg-linear-to-br from-[#1A56DB]/10 to-[#3B82F6]/10 opacity-0 group-hover/card:opacity-100 transition-opacity duration-300" />
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                                        <h4 className="font-bold text-white text-base sm:text-lg truncate pr-2 group-hover/card:text-[#60A5FA] transition-colors duration-300">
                                            {org.orgName}
                                        </h4>
                                        <div className={`w-2 h-2 rounded-full shrink-0 transition-all duration-300 ${selectedOrg === org.id
                                            ...
                                            : 'bg-[#60A5FA] shadow-lg shadow-[#60A5FA]/50'
                                            }`} />
                                    </div>

                                    <div className="space-y-2 sm:space-y-3 mb-3 sm:mb-4">
                                        <div className="flex items-center justify-between p-2 bg-slate-900/30 rounded-lg backdrop-blur-sm border border-slate-700/30 group-hover/card:border-[#3B82F6]/30 transition-all duration-300">
                                            <span className="text-xs sm:text-sm text-slate-400 flex items-center gap-2">
                                                <div className="w-8 h-8 bg-linear-to-br from-[#1A56DB]/20 to-[#3B82F6]/20 rounded-lg flex items-center justify-center">
                                                    <DollarSign className="w-4 h-4 text-[#3B82F6]" />
                                                </div>
                                                Treasury
                                            </span>
                                            <span className="text-xs sm:text-sm font-semibold text-[#60A5FA] group-hover/card:scale-110 transition-transform duration-300">
                                                {formatLamports(org.treasury)}
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between p-2 bg-slate-900/30 rounded-lg backdrop-blur-sm border border-slate-700/30 group-hover/card:border-[#60A5FA]/30 transition-all duration-300">
                                            <span className="text-xs sm:text-sm text-slate-400 flex items-center gap-2">
                                                <div className="w-8 h-8 bg-linear-to-br from-[#3B82F6]/20 to-[#60A5FA]/20 rounded-lg flex items-center justify-center">
                                                    <Users className="w-4 h-4 text-[#60A5FA]" />
                                                </div>
                                                Workers
                                            </span>
                                            <span className="text-xs sm:text-sm font-semibold text-white group-hover/card:text-[#60A5FA] group-hover/card:scale-110 transition-all duration-300">
                                                {org.workers.length}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="relative w-full py-2 bg-linear-to-r from-[#1A56DB]/20 to-[#3B82F6]/20 hover:from-[#1A56DB]/30 hover:to-[#3B82F6]/30 text-[#60A5FA] rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 flex items-center justify-center gap-2 border border-[#1A56DB]/20 hover:border-[#3B82F6]/40 group/btn overflow-hidden"
                                    >
                ...
                <div className="p-4 border-t border-slate-800/50 bg-linear-to-r from-slate-900/80 to-slate-800/60 backdrop-blur-sm">
                    <div className="flex items-center justify-between text-xs text-slate-400">
                        <div className="flex items-center gap-2">
                            <div className="w-2 h-2 bg-linear-to-r from-[#1A56DB] to-[#3B82F6] rounded-full animate-pulse" />
